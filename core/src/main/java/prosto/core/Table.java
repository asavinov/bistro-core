...
import prosto.core.operations.OpProduct;
import prosto.core.operations.OpRange;
import prosto.core.data.TableDataImpl;
...
public class Table implements Element {
    ...
    private List<ProstoException> errors = new ArrayList<>();
    @Override
    public List<ProstoException> getErrors() { // Empty list in the case of no errors
        return this.errors;
    }
    ...
    public void evaluate() {
        ...
        catch(ProstoException e) {
            this.errors.add(e);
        }
        catch(Exception e) {
            this.errors.add( new ProstoException(ProstoErrorCode.EVALUATION_ERROR, e.getMessage(), "Error populating table.") );
        }
    }
    ...
    public void setOperation(Operation operation) {
        ...
        if(this.hasDependency(this)) {
            ...
            throw new ProstoException(ProstoErrorCode.DEFINITION_ERROR, "Cyclic dependency.", "This table depends on itself directly or indirectly.");
        }
    }
    ...
    public Table(Schema schema, String name) {
        ...
        this.data = new TableDataImpl(this);
    }
}
