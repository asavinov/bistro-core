...
import prosto.core.data.ColumnDataImpl;
import prosto.core.operations.*;
...
public class Column implements Element {
    ...
    public void evaluate() { // Evaluate only this individual column if possible
        ...
        try {
            ...
            this.errors.add( new ProstoException(ProstoErrorCode.EVALUATION_ERROR, e.getMessage(), "Error evaluating column.") );
        }
