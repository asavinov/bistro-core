...
public class OpProject extends OpLink {
    ...
    void validate() {
        ...
        if(nonKeyColumn != null) {
            throw( new ProstoException(ProstoErrorCode.DEFINITION_ERROR, "Column operation error.", "All keys in the project-column operation must be key columns of the output product-table.")) ;
        }
    }
